...
def p_logical_and_expression(p):
    ...
    if len(list(p))==4:
        ...
        if(type(term1) == tuple and type(term2) == tuple):
            ...
            ll = ['and','t' + str(term1[0]),str(term2),'t'+str(tindex)]
        elif(type(term2) == tuple):
            p[0] = (tindex,retrieve(term1) and retrieve(term2[1]))
            ll = ['and',str(term1),'t' + str(term2[0]),'t'+str(tindex)]
        else:
            p[0] = (tindex,retrieve(term1) and retrieve(term2))
            ll = ['and',str(term1),str(term2),'t'+str(tindex)]
        quad_table.append(ll)
    else:
        p[0] = p[1:]
...
def p_logical_or_expression(p):
    ...
    if len(list(p))==4:
        ...
        if(type(term1) == tuple and type(term2) == tuple):
            ...
            ll = ['or','t' + str(term1[0]),str(term2),'t'+str(tindex)]
        elif(type(term2) == tuple):
            p[0] = (tindex,retrieve(term1) or retrieve(term2[1]))
            ll = ['or',str(term1),'t' + str(term2[0]),'t'+str(tindex)]
        else:
            p[0] = (tindex,retrieve(term1) or retrieve(term2))
            ll = ['or',str(term1),str(term2),'t'+str(tindex)]
        quad_table.append(ll)
    else:
        p[0] = p[1:]
...
def p_selection_statement(p):
    '''selection_statement : IF '(' expression ')' ifmarker statement elsemarker
    | IF '(' expression ')' ifmarker statement ELSE elsemarker statement'''
    p[0] = p[1:]
